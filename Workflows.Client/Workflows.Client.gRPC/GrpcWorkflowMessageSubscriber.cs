...
{
    /// <summary>
    /// Implements <see cref="IMessageSubscriber"/> for receiving gRPC-based message notifications.
    /// Handlers are registered in memory and invoked by the gRPC service implementations.
    /// </summary>
    public class GrpcWorkflowMessageSubscriber : IMessageSubscriber
    {
