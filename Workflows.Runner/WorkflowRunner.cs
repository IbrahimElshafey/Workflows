...
//            while (parent != null)
//            {
//                if (((parent is GroupWaitDto)) || ((parent is SubWorkflowWaitDto)))
//                {
...
//        private static bool IsGroupWaitCompleted(GroupWaitDto group)
//        {
...
//            if (wait is Definition.GroupWait groupWait && waitDto is GroupWaitDto waitsGroupDto)
...
//        private void PrepareGroupWaitForPersistence(Definition.GroupWait groupWait, GroupWaitDto waitsGroupDto)
//        {
...
//                Definition.GroupWait => new GroupWaitDto(),
